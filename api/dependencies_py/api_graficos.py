...
def graficos_drawdown():
    ...
    try:
        ...
        df_lucro = carregar_json(temp_path, "resultados_ciclos_lucro.json")
        stats_lucro = carregar_json(temp_path, "estatisticas_ciclos_lucro.json")
...
def grafico_divida_acumulada():
    ...
    try:
        ...
        minima = estatisticas.get("Máxima Dívida do Ciclo", 0)
